...
ipv4_n = "127.0.0.1/30"
ipv6_n = "2001:0db8:85a3:0000:0000:8a2e:0370:7334/64"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (IpNetwork, ipv4_n, ipaddress.IPv4Network(ipv4), "1.2.3", {}),
        (IpNetwork, ipv6_n, ipaddress.IPv6Network(ipv6), "1.2.3", {}),
        (IpNetwork, ipv4_n, ipaddress.IPv4Network(ipv4), ipv6, {"protocol": 4}),
        (IpNetwork, ipv6_n, ipaddress.IPv6Network(ipv6), ipv4, {"protocol": 6}),
        (IpNetwork, "", "", "1.2.3", {"blank": True}),
    ],
)
