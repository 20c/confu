...
@pytest.mark.parametrize(
    ...
    [
        ...
        (TimeDuration, ["2d 2h 2m 2s 2ms", "3m", 120], [180122.002, 180, 120]),
        (
            TimeDuration,
            lambda x: ["2d 2h 2m 2s 2ms", "3m", 120],
            [180122.002, 180, 120],
        ),
        (Directory, ["/a", "/b"], ["/a", "/b"]),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Float, 1.23, 1.23),
        (TimeDuration, "2d 2h 2m 2s 2ms", 180122.002),
        (TimeDuration, lambda x: "2d 2h 2m 2s 2ms", 180122.002),
